...
export default function Create({ kpi, organizationalUnits }: Props) {
                ...
                <div className="mx-auto max-w-3xl space-y-6 p-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Define the action plan and assign the
                                organizational units responsible for it.
                            </CardDescription>
                        </CardHeader>
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g. Conduct faculty development training"
                                        disabled={processing}
                                    />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="Describe the activities, deliverables, and expected results..."
                                        rows={6}
                                        disabled={processing}
                                    />
